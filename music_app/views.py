...
def home(request):
    ...
    return render(request,'music_app/home.html',{"my_playlists":playlists})
...
def playlist(request,id):
    ...
    return render(request,'music_app/songs.html',{"songs":songs,"playlist_name": playlist_name})
...
def edit(request,id):
    ...
    if form.is_valid():
        ...
        return render(request,'music_app/edit.html',{"form":form,"status": "Your song is updated successfully!" })

    return render(request,'music_app/edit.html',{"form":form})
...
def signup(request):
    ...
    if form.is_valid():
        ...
        if(password!= confirm_password):
            return render(request,'music_app/signup.html',{"form":form,"status":"Your passwords don't match!"})
        else:
            try:
                user= User.objects.get(email=email)
                return render(request,'music_app/signup.html',{"form":form,"status":"This email already exists in the system! Please log in instead."})
            except Exception as e:
                print(e)
                new_user = User.objects.create_user(username= name, email= email,password= password)
                new_user.save()
                return render(request,'music_app/signup.html',{"form":form,"status":"Signed up Successfully!"})
...
def login(request):
    ...
    return render(request,'music_app/login.html',{"form":form,"status":status})
